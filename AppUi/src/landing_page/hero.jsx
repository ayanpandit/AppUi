        ...
        >
          ...
          <div className="pt-48" style={{ pointerEvents: "auto", maxWidth: "fit-content" }}>
            ...
            <div className="mt-8 flex items-center gap-4" style={{ width: 'fit-content' }}>
              ...
              <a href="https://github.com/ayanpandit/AppUi" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-3 border border-white/20 text-white/90 rounded hover:bg-white/5 transition-colors">
