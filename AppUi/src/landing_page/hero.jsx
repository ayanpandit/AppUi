      ...
      <div style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", pointerEvents: "none" }}>
        ...
        <nav className="flex items-center justify-between px-8 py-6" style={{ pointerEvents: "none" }}>
          ...
          <div className="flex items-center gap-8" style={{ pointerEvents: "auto" }}>
            ...
            <a href="#" className="text-white/90 text-sm font-medium hover:text-white transition-colors flex items-center gap-1">
              Resources
              <span className="text-xs">▼</span>
            </a>
            <a href="/dashboard" className="text-white/90 text-sm font-medium hover:text-white transition-colors">
              Login
            </a>
        ...
        <div className="flex flex-col justify-between px-8 pb-12" style={{ height: "calc(100vh - 88px)", pointerEvents: "none" }}>
          ...
          <div className="pt-48" style={{ pointerEvents: "auto", maxWidth: "fit-content" }}>
            ...
            <div className="mt-8 flex items-center gap-4" style={{ width: 'fit-content' }}>
              <a href="/components" className="bg-gradient-to-r from-[#c4ff0e] via-[#00ffff] to-[#c4ff0e] bg-[length:200%_100%] text-black font-bold px-6 py-3 rounded-lg flex items-center gap-3 group relative overflow-hidden hover:shadow-[0_0_30px_rgba(196,255,14,0.5)] transition-all duration-300 hover:scale-105 animate-gradient" style={{ backgroundPosition: '0% 50%' }}>
