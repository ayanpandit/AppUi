  ...
  return (
    <nav className="w-full h-20 md:h-24 lg:h-28 flex items-center justify-between px-4 md:px-8 bg-black">
      ...
      <div className="flex items-center">
        <div className="text-white font-black tracking-tighter" style={{ fontSize: '2rem', fontFamily: 'system-ui, -apple-system, sans-serif', letterSpacing: '-0.08em', lineHeight: '1' }}>
          APP.UI
        </div>
